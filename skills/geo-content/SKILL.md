...
5. **Competitor comparison**: Do competitors cover subtopics that this site misses? Use WebFetch to check 2-3 competitor sites and compare content depth, word count, and topic coverage. **Every competitor claim must link to the specific competitor page being referenced** (e.g., "Competitor X's service page (https://example.com/services/video) covers 1,200 words with embedded case studies, while this site's equivalent page is 300 words"). Do not make claims about competitor content without verifiable URLs.
