...
### Step 4: Competitive Comparison (Optional but Recommended)

If competitors are identified, scan their platform presence for context. This helps calibrate the score — a brand with "moderate" Reddit presence in an industry where competitors have zero Reddit presence is relatively strong.

**IMPORTANT — Competitor Evidence Standard:** Every competitor claim in this report must include a verifiable URL. When comparing platform presence, link to the competitor's actual profile or page on that platform. For example:
- YouTube: link to their channel URL (e.g., `https://youtube.com/@competitorname`)
- Reddit: link to specific threads or their subreddit
- Wikipedia: link to their Wikipedia article
- LinkedIn: link to their company page
- Clutch/review platforms: link to their profile page (e.g., `https://clutch.co/profile/competitor-name`)

Do not write "Competitor X has verified Clutch reviews" without linking to their Clutch profile. Use WebFetch to verify competitor URLs before including them.
...
[If competitors were analyzed, show a brief comparison table. Every competitor entry must link to their actual platform profiles.]
...
### Competitor Platform URLs
For each competitor listed above, provide verified links to their profiles:
- **[Competitor 1]**: YouTube: [URL] | Reddit: [URL or "not found"] | Wikipedia: [URL or "no article"] | LinkedIn: [URL] | Clutch: [URL or "not listed"]
- **[Competitor 2]**: YouTube: [URL] | Reddit: [URL or "not found"] | Wikipedia: [URL or "no article"] | LinkedIn: [URL] | Clutch: [URL or "not listed"]
